...
const Engine_Metrics_Dashboard = () => {
    ...
    <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <MetricCard
          ...
          value={fmt(latest?.intake_air_temp_c, 1)}
          unit="°C"
          subtitle="Engine temperature"
        />
        <MetricCard
          title="Timing Advance Degree"
          value={fmt(latest?.timing_advance_deg, 1)}
          unit="°"
          subtitle="Engine Spark Plug"
        /> 
      </div>
    </div>
  );
...
export default Engine_Metrics_Dashboard;